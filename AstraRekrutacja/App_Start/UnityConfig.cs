...
using AstraRekrutacja.Services.Services;
...
namespace AstraRekrutacja
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<IWorkerLeavesService, WorkerLeavesService>(new TransientLifetimeManager());
            container.RegisterType<IWorkerLeavesExcelService, WorkerLeavesExcelService>(new TransientLifetimeManager());
        }
    }
}